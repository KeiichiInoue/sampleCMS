...
class RegistrantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create registrant" do
    assert_difference('Registrant.count') do
      post registrants_url, params: { registrant: { device_info: @registrant.device_info, device_type: @registrant.device_type, name: @registrant.name } }
    end
  ...
  test "should update registrant" do
    patch registrant_url(@registrant), params: { registrant: { device_info: @registrant.device_info, device_type: @registrant.device_type, name: @registrant.name } }
